function performOperations<T extends number, U extends number, V>(num1: T, num2: U): V {
    const addition = (num1: T, num2: U) => num1 + num2;
    const subtraction = (num1: T, num2: U) => num1 - num2;
    const multiplication = (num1: T, num2: U) => num1 * num2;
    const division = (num1: T, num2: U) => num1 / num2;
    ...
    return resultDivision as unknown as V;
}
