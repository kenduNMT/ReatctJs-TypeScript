...
function multiply<T>(num1: T, num2: T): T {
    if (typeof num1 === 'number' && typeof num2 === 'number') {
        return num1 * num2 as any;
    } else if (typeof num1 === 'string' && typeof num2 === 'string' && !isNaN(parseFloat(num1)) && !isNaN(parseFloat(num2))) {
        return (parseFloat(num1) * parseFloat(num2)) as any;
...
function divide<T>(num1: T, num2: T): T {
    if (typeof num1 === 'number' && typeof num2 === 'number') {
        if (num2 === 0) {
